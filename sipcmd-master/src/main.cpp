/**
 *  /// example - ./sipcmd2 -P sip -u "111" -c "guest1" -w "192.168.1.234" -x "w2000;c120;w2000;h"
    ///            ./sipcmd2 -P sip -u "111" -c "guest1" -w "192.168.1.234" -x "w2000;lstart;a;lwai;"


    ./sipcmd -P sip -u "111" -c "guest1" -w "192.168.1.234" -x "w2000;c120;w2000;h"
	./sipcmd -P sip -u "111" -c "guest1" -w "192.168.1.234" -x "w2000;lstart;a;lwai";
 * 
 *  In call with sip:111@10.10.114.25:5060 using sip:120@192.168.1.234:5060 token=[Cffade0ec1]
    Incoming call from sip:120@192.168.1.234:5060
    Close [ Call[Cffade0ec1]-EP<local>[L79453ec52] - 0x7fbc64019760 ]
    TestChanAudio::CloseChannel
    StopAudioPlayback
    StopAudioRecording
    OnClosedMediaStream
    OnClosedMediaStream
    Close [ Call[Cffade0ec1]-EP<local>[L79453ec52] - 0x7fbc640247a0 ]
    TestChanAudio::CloseChannel
    StopAudioPlayback
    StopAudioRecording
    OnClosedMediaStream
    ...
    OnClosedMediaStream
    OnReleased: reason: EndedByRemoteUser
    OnClearedCall
    ~LocalConnection
